...
- **학습 관련 대화**: 424개 (80.3%) - 질문이 있는 대화 기준
- **학습 관련 메시지**: 4,305개 (49.3%) - 키워드/질문/기술용어 기반
- **생성된 차트**: 1개 (4개 분석 차트 포함)
- **토픽 분류**: 8개 카테고리 (AI/ML, Data, Development, Education, Business, Cloud/Infra, Design, General)
- **주요 토픽**: General (4,922개, 56.4%), AI/ML (1,575개, 18.0%)
- **학습 분야별 메시지 분포**: AI/ML (18.0%) + Data (7.3%) + Development (7.0%) + Education (4.6%) + Business (3.7%) + Cloud/Infra (1.7%) + Design (1.3%) = 43.6% (3,808개)
- **전체 학습 분포**: General (56.4%) + 특정 분야 (43.6%) = 100%
- **평균 단어 수**: 710개
- **평균 질문 깊이**: 0.33
